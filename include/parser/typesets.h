...
namespace Typeset {
    ...
    constexpr Checker isLeftBracket   = []( const T &t ) { return isBracket(t) && (static_cast<int>(t) % 2 == 0) };
    constexpr Checker isRightBracket  = []( const T &t ) { return isBracket(t) && (static_cast<int>(t) % 2 == 1) };
};
